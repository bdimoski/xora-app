        ...
        <section>
            <Element name='faq' className='relative'>
                <div className='container relative z-2 py-28'>
                    <div>
                        <h3 className='h3 max-md:h5 max-w-640 max-lg:max-w-md mb-7 text-p4'>Curiosity didn't kill the
                            cat, it
                            gave it answers</h3>
                ...
                <div className='faq-glow_before relative z-2 border-2 border-s2 bg-s1'>
                    ...
                    <div
                        className='faq-line_after absolute left-[calc(50%-1px)] top-0 -z-1 h-full w-0.5 bg-s2 max-lg:hidden'/>
                </div>
            </Element>
        </section>
    )
