                        ...
                        {features.map(({id, icon, caption, title, text, button}) => (
                            ...
                            >
                                <div className='w-full flex justify-start items-center'>
                                    <div className='-ml-3 mb-12 flex items-center justify-between flex-col'>
                        ...
                        border-2 border-s3 rounded-7xl max-md:hidden'>
                            ...
                            {details.map(({id, icon, title}) => (
                                <li key={id} className='relative pt-16 px-4 pb-14'>
                                    <div className='absolute top-0 bottom-0 left-1/2 bg-s3/20 w-[1px]'/>
                                    <div
                                    ...
                                    <h3 className='relative z-2 max-w-36 mx-auto my-0 base-sm text-center'>{title}</h3>
                                </li>
                            ))}
                        </ul>
                    </div>
