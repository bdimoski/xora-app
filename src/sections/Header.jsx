    ...
    return (
        <header className={clsx('fixed top-0 left-0 z-50 w-full py-10 transition-all duration-500 max-lg:py-4',
            ...
            <div className='container flex h-14 items-center max-lg:px-5'>
                <a className='lg:hidden flex-1 cursor-pointer x-2'>
                ...
                max-lg:overflow-hidden sidebar-before max-md:px-4'>
                        ...
                        -translate-y-1/2 rotate-90'>
                            <img src="/images/bg-outlines.svg" alt="outline" width={960} height={380}
                                 className='relative z-2'/>
                            <img src="/images/bg-outlines-fill.png" alt="outline" width={960} height={380}
